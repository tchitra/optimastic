    ...
    class SGD : public IOptimizer<Function>  {
        public:
          ...
          SGD(Function f, Domain initial_condition,
              ...
              : __current_min(initial_condition)
          ...
          void run_optimizer(size_t k) { 
              ...
              while (steps_left > 0) {
                  ...
                  double prefactor =  1.0 / (_decay + this->_current_step);
                  int i = _prng_ptr->generate(); 

                  // Accumulate velocity
                  _current_velocity *= _friction_coefficient;
                  this->_f.accum_partial_gradient(i, _current_min, _current_velocity); 
          ...
          const double min() { 
              this->_f(_current_min);
          }

        private:
          Domain __current_min;
